...
public class PcmToWav {
    ...
    public static boolean mergePCMFilesToWAVFile(List<String> filePathList, String destinationPath) {
        ...
        Log.e( "mergePCMFilesToWAVFile: ","fileNum = " +fileNum );
        for (int i = 0; i < fileNum; i++) {
            file[i] = new File(filePathList.get(i));
            Log.e( "mergePCMFilesToWAVFile: ","file[i] = " +file[i] );
            TOTAL_SIZE += file[i].length();
            Log.e( "mergePCMFilesToWAVFile: ","TOTAL_SIZE = " +TOTAL_SIZE );
        }
        ...
        try {
            h = header.getHeader();
            Log.e( "mergePCMFilesToWAVFile: ","h = " +h.length );
