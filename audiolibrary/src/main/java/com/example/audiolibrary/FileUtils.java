...
public class FileUtils {
    ...
    private  static String MyVoicePath="MyVoicePath";
    //原始文件(不能播放)
    private final static String AUDIO_PCM_BASEPATH = "/"+MyVoicePath+"/pcm/";
    //可播放的高质量音频文件
    private final static String AUDIO_WAV_BASEPATH = "/"+MyVoicePath+"/wav/";

    private static void setRootPath(String rootPath){
        FileUtils.MyVoicePath=rootPath;
    }
